...
data interestingly;
retain sys_risk smb hml benchmark_adjusted_return pred resid;
set interestingly;
keep sys_risk smb hml benchmark_adjusted_return pred resid;
run;quit;
...
data interestingly;
retain sys_risk sys_square smb hml benchmark_adjusted_return pred resid;
set interestingly;
keep sys_risk sys_square smb hml benchmark_adjusted_return pred resid;
run;quit;
...
%let m=20180111;*fill in export date;
