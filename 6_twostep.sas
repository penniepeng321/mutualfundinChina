...
set five.firststep;
if _TYPE_="PARMS";
keep windcode Benchmark_ret changeratefundnav_adj;
run;
data five.firststep_p;
set five.firststep_p;
adjust=Benchmark_ret*changeratefundnav_adj;
keep windcode adjust;
run;
proc sql;
...
set temp;
bar=changeratefundnav_adj+adjust*Benchmark_ret;
run;
...
proc reg data=five.fund_benchmark_weight4_3y outest=five.firststep3y edf  tableout  noprint;
model changeratefundnav_adj = Benchmark_ret;
by windcode;
quit;
data five.firststep3y_p;
set five.firststep3y;
if _TYPE_="PARMS";
keep windcode Benchmark_ret changeratefundnav_adj;
run;
data five.firststep3y_p;
set five.firststep3y_p;
adjust=Benchmark_ret*changeratefundnav_adj;
keep windcode adjust;
run;
proc sql;
create table temp as
select a.* , b.adjust
from five.fund_benchmark_weight4_3y as a , five.firststep3y_p as b 
where a.windcode = b.windcode;
quit;
data five.fund_benchmark_weight4_3y;
set temp;
...
proc reg data=five.fund_benchmark_weight4_5y outest=five.firststep5y edf  tableout  noprint;
model changeratefundnav_adj = Benchmark_ret;
by windcode;
quit;
data five.firststep5y_p;
set five.firststep5y;
if _TYPE_="PARMS";
keep windcode Benchmark_ret changeratefundnav_adj;
run;
data five.firststep5y_p;
set five.firststep5y_p;
adjust=Benchmark_ret*changeratefundnav_adj;
keep windcode adjust;
run;
proc sql;
create table temp as
select a.* , b.adjust
from five.fund_benchmark_weight4_5y as a , five.firststep5y_p as b 
where a.windcode = b.windcode;
quit;
data five.fund_benchmark_weight4_5y;
set temp;
...
proc reg data=five.fund_benchmark_weight4_7y outest=five.firststep7y edf  tableout  noprint;
model changeratefundnav_adj = Benchmark_ret;
by windcode;
quit;
data five.firststep7y_p;
set five.firststep7y;
if _TYPE_="PARMS";
keep windcode Benchmark_ret changeratefundnav_adj;
run;
data five.firststep7y_p;
set five.firststep7y_p;
adjust=Benchmark_ret*changeratefundnav_adj;
keep windcode adjust;
run;
proc sql;
create table temp as
select a.* , b.adjust
from five.fund_benchmark_weight4_7y as a , five.firststep7y_p as b 
where a.windcode = b.windcode;
quit;
data five.fund_benchmark_weight4_7y;
set temp;
...
proc reg data=five.fund_benchmark_weight4 outest=five.reg_fbw4_bench edf  tableout  noprint;
  ...
  *xaxis discreteorder=data;
  ...
  model bar = sys_risk sys_square smb hml;
  by windcode;
  quit;
  data five.a1 five.a2;
  ...
  *xaxis discreteorder=data;
  ...
  data interestingly;
  retain sys_risk smb hml bar pred resid;
  set interestingly;
  keep sys_risk smb hml bar pred resid;
  run;quit;
  ...
  %boot(data=interestingly,stat=Intercept,residual=resid,samples=1000,
        equation=bar=pred_a+resid,random=5673);
  ...
  data interestingly;
  retain sys_risk sys_square smb hml bar pred resid;
  set interestingly;
  keep sys_risk sys_square smb hml bar pred resid;
  run;quit;
  ...
  equation=bar=pred_g+resid,random=5673);
