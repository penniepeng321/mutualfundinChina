...
proc means data=brinson.Indexcomponents noprint;
...
from brinson.Indexcomponents as a left join indcomp2 as b 
...
run;
*these two stocks terminated ipo;
...
*consider choice of semi-annual window for stock return;

*%let endm=6;
*%let startm=%eval(&endm+6);*already set at the beginning;

data ptgpsumo1;
set ptgpsumo1;
if report='n' and &endm ne 0 then do; year1=year+1; month1=&endm; end;
if report='z' and &endm ne 0 then do; year1=year; month1=&startm; end;
if report='n' and &endm = 0 then do; year1=year; month1=12; end;
if report='z' and &endm = 0 then do; year1=year; month1=6; end;
run;
...
select a.*, b.* 
from ptgpsumo1 as a left join brinson.Stkpmonthlysemiret as b 
on a.stockcode = b.windcode and a.year1=b.year and a.month1=b.month;
run;quit;
...
*for bench data, we need semiannual data at month 6 and 12 to compare with;
*year-mid and year-end fund holding report;
data indcompo1;
set indcompo1;
year=year(date);
month=month(date);
...
data indcompo1;
set indcompo1;
if month=12 and &endm ne 0 then do; year1=year+1; month1=&endm; end;
if month=6 and &endm ne 0 then do; year1=year; month1=&startm; end;
if month=12 and &endm = 0 then do; year1=year; month1=12; end;
if month=6 and &endm = 0 then do; year1=year; month1=6; end;
run;

proc sql;
create table brinson.benchholding as
select a.*, b.* 
from indcompo1 as a left join brinson.Stkpmonthlysemiret as b 
on a.wind_code = b.windcode and a.year1=b.year and a.month1=b.month;
run;quit;
...
data brinson.brinson&endm&startm;
set brinson.benchfundc5;
run;
